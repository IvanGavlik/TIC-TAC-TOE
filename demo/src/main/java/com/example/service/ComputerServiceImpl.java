...
public class ComputerServiceImpl implements ComputerService {
	...
	public void playMove(Game game) {
		...
		Move bestMove = minMax(game.getBoard(), game.getCurrentPlayer());
		game.getBoard()[bestMove.row][bestMove.column] = "X";
		
		System.out.println("move: " + Arrays.deepToString(game.getBoard()));
	}
